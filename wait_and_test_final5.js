...
(async () => {
  ...
  await page.screenshot({ path: 'game_screenshot_final9.png', fullPage: true });
  await browser.close();
  
  const testCode = `
const fs = require('fs');
const { PNG } = require('pngjs');
fs.createReadStream('game_screenshot_final9.png')
  ...
  .on('parsed', function() {
    ...
    console.log('Yellow Pixels:', yellow);
      ...
      `;
  fs.writeFileSync('temp_test6.js', testCode);
  execSync('node temp_test6.js', {stdio: 'inherit'});
})();
