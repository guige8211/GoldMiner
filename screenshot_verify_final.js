...
(async () => {
  ...
  await page.screenshot({ path: 'game_screenshot_final10.png', fullPage: true });
  await browser.close();
  
  const testCode = `
const fs = require('fs');
const { PNG } = require('pngjs');
fs.createReadStream('game_screenshot_final10.png')
  ...
  `;
  fs.writeFileSync('temp_test7.js', testCode);
  execSync('node temp_test7.js', {stdio: 'inherit'});
})();
