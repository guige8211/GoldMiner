...
(async () => {
  ...
  await page.screenshot({ path: 'game_screenshot_final6.png', fullPage: true });
  await browser.close();
  
  const testCode = `
const fs = require('fs');
const { PNG } = require('pngjs');
fs.createReadStream('game_screenshot_final6.png')
  ...
  .on('parsed', function() {
    ...
    console.log('Yellow Pixels:', yellow);
      ...
      `;
  fs.writeFileSync('temp_test3.js', testCode);
  execSync('node temp_test3.js', {stdio: 'inherit'});
})();
